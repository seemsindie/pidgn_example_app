...
pub const ctrl = pidgn.Controller.define(.{}, &.{
    pidgn.Router.get("/login", loginPage).named("login"),
    pidgn.Router.get("/dashboard", dashboard).named("dashboard"),
    pidgn.Router.post("/api/protected", protectedAction),
    pidgn.Router.get("/old-page", oldPage),
    pidgn.Router.get("/set-cookie", setCookieDemo),
    pidgn.Router.get("/delete-cookie", deleteCookieDemo),
});
...
fn protectedAction(ctx: *pidgn.Context) !void {
...
fn oldPage(ctx: *pidgn.Context) !void {
    ctx.redirect("/about", .moved_permanently);
}

fn setCookieDemo(ctx: *pidgn.Context) !void {
...
fn deleteCookieDemo(ctx: *pidgn.Context) !void {
